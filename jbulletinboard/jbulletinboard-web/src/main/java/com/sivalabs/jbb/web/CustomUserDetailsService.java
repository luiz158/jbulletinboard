...
import com.sivalabs.jbb.web.domain.AuthenticatedUser;
import com.sivalabs.jbb.web.service.AuthenticationService;
...
public class CustomUserDetailsService implements UserDetailsService
{
	...
	{
		com.sivalabs.jbb.web.domain.User user = authenticationService.getUserByUsername(username);
